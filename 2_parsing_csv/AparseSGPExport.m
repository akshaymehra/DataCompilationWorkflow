function AparseSGPExport(SGPExport, UCCDatafile, sigmaString, ...
    ...
    [CaOStar, CaOStarApprox] = CaOCalcs(fSShalesdDataset.Na2O, ...
    ...
    % fSShalesdDataset.Eu_star = eustar.(fSShalesdDataset.Nd, ...
    %   fSShalesdDataset.Sm, fSShalesdDataset.Gd, fSShalesdDataset.Tb);
    % Now, write to file
    writetable(fSShalesdDataset, ...
